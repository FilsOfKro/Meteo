...
/**
 * @author dcollins
 * @version $Id: GraticuleAttributesPanel.java 1171 2013-02-11 21:45:02Z
 *          dcollins $
 */
...
public class GraticuleAttributesPanel extends JPanel {
  ...
  private void makeComponents() {
    // ---------- Line Properties ----------//
    {
      String[] lineStyles = new String[] { MGRSGraticuleLayer.LINE_STYLE_SOLID, MGRSGraticuleLayer.LINE_STYLE_DASHED,
      ...
      this.lineWidthSlider = new JSlider(MIN_LINE_WIDTH * LINE_WIDTH_SCALE, // min
      ...
      this.lineWidthSpinnerModel = new SpinnerNumberModel((double) MIN_LINE_WIDTH, // value
  ...
  private static class ColorPanel extends JPanel {
    ...
    private void makeComponents() {
      ...
      this.opacitySlider = new JSlider(1, // min
          255); // max
    ...
    private void setColorLabel(Color color) {
      if (color != null && this.colorLabel != null && this.colorLabel.getIcon() != null
